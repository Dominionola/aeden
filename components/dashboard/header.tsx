...
import { Bell, Settings, LogOut, User, Sparkles, Menu } from "lucide-react";
...
export function Header({ isThreadsConnected = false }: { isThreadsConnected?: boolean }) {
                    ...
                    <SheetContent side="left" className="w-[300px] p-0 flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col">
                            ...
                            <div className="px-3 pb-4 space-y-3 mt-auto">
                                ...
                                {!isThreadsConnected && (
                                    <div className="rounded-2xl p-4 bg-gray-50 border border-gray-100 mx-1">
